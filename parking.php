...
<html lang="en">
   ...
   <body class="main-layout inner_page">
      ...
      <div class="container">
           ...
           <div class="col-md-12">
            <form action="a.php" method="post">
                 <div class="form-group">
                    <label for="apartmentName1">Apartment Name</label>
                    <input type="text" class="form-control" id="apartmentName1" placeholder="Enter Apartment Name">
                 </div>
                 <div class="form-group">
                    <label for="parkingLotId1">Parking Lot ID</label>
                    <input type="text" class="form-control" id="parkingLotId1" placeholder="Enter Parking Lot ID">
                 </div>
        ...
        <div class="row">
           <div class="col-md-12">
              <div id="remainingSpaces" style="display: none;">
                 <!-- Remaining spaces will go here -->
              </div>
           </div>
        </div>
