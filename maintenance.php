            ...
            <div class="col-md-12">
               <form action="maintenance.php" method="post">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control" id="apartmentName" placeholder="Enter Apartment Name" name="apartmentName">
                  </div>
                  <div class="form-group">
                     <label for="buildingName">Building Name</label>
                     <input type="text" class="form-control" id="buildingName" placeholder="Enter Building Name" name="buildingName">
                  </div>
                  <div class="form-group">
...
?>
         ...
         <div class="row">
            <div class="col-md-12">
               <div id="managementFee" style="display: none;">
                  <!-- Management fee will go here -->
               </div>
            </div>
         </div>
      </div>
